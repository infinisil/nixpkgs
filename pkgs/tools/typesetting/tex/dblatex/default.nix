{ lib, stdenv, fetchurl, python3, libxslt, texlive, enableAllFeatures ? false
, imagemagick, fig2dev, inkscape, fontconfig, ghostscript
...
, tex ? texlive.combine { # satisfy all packages that ./configure mentions
  inherit (texlive)
      ...
      multirow overpic pdfpages pdflscape graphics stmaryrd subfigure titlesec
      wasysym
