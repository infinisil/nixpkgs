...
let
  ...
  suffix = lib.optionalString (channel != "stable" && channel != "ungoogled-chromium") (
    "-" + channel
  );
...
// builtins.removeAttrs chromium.browser (
  builtins.filter (e: e != "version") (builtins.attrNames chromium.browser)
)
