...
let
  ...
  dist = {
    aarch64-darwin = rec {
      ...
      url =
        "https://github.com/lima-vm/lima/releases/download/v${version}/lima-${version}-${archSuffix}.tar.gz";
      sha256 =
        "092d586426f85c61263bd4822c22538b1585dc84d0369dccac936db758a17ce1";
    };
    ...
    x86_64-darwin = rec {
      ...
      url =
        "https://github.com/lima-vm/lima/releases/download/v${version}/lima-${version}-${archSuffix}.tar.gz";
      sha256 =
        "6c6278ddc2db080b4ad6a2f39ae36e6258efd6c696fbe599a5d389cfb9232aa1";
    };
    ...
    aarch64-linux = rec {
      ...
      url =
        "https://github.com/lima-vm/lima/releases/download/v${version}/lima-${version}-${archSuffix}.tar.gz";
      sha256 =
        "e33301878082cb73eb9bc4f267b91eb4895ac3c8303d56d4b86c1264563bfcff";
    };
    ...
    x86_64-linux = rec {
      ...
      url =
        "https://github.com/lima-vm/lima/releases/download/v${version}/lima-${version}-${archSuffix}.tar.gz";
      sha256 =
        "be6093c2a9b0aa3c39cc5a5e39e79223c6d03f0e07ebadf70c3c128143672a84";
    };
  };
in stdenvNoCC.mkDerivation {
  ...
  passthru.updateScript = let lima-bin = builtins.toString ./bin.nix;
  in writeScript "update-lima-bin.sh" ''
