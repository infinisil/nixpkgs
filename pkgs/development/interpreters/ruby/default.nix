...
, Foundation, buildEnv, bundler, bundix, cargo, rustPlatform, rustc
, makeBinaryWrapper, buildRubyGem, defaultGemConfig, removeReferencesTo, openssl
, openssl_1_1, linuxPackages, libsystemtap }@args:
  ...
  generic = { version, sha256, cargoSha256 ? null }:
    let
      ...
      self = lib.makeOverridable ({ stdenv, buildPackages, lib, fetchurl
        ...
        , removeReferencesTo, jitSupport ? yjitSupport, cargo, rustPlatform
        , rustc, yjitSupport ? yjitSupported, autoreconfHook, bison, autoconf
        , buildEnv, bundler, bundix, libiconv, libobjc, libunwind, Foundation
        ...
        stdenv.mkDerivation rec {
          ...
          meta = with lib; {
            ...
            knownVulnerabilities = op (lib.versionOlder ver.majMin "3.0")
              "This Ruby release has reached its end of life. See https://www.ruby-lang.org/en/downloads/branches/.";
          };
