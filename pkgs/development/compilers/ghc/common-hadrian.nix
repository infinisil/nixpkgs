  ...
  ghcSrc ? srcOnly {
    ...
    patches =
      ...
      [
        ...
        (if lib.versionAtLeast version "9.8" then ./docs-sphinx-7-ghc98.patch else ./docs-sphinx-7.patch)
      ]
      ...
      tools =
        {
          ...
          install_name_tool = if stdenv.targetPlatform.isAarch64 then cc.bintools else cc.bintools.bintools;
          # Same goes for strip.
          strip =
