  ...
  ((callFile ./common/builder.nix { }) (
    {
      ...
      src =
        if is6 && stdenv.targetPlatform.isVc4 then
          fetchFromGitHub {
            owner = "itszor";
            repo = "gcc-vc4";
        ...
        else if is6 && stdenv.targetPlatform.isRedox then
          fetchFromGitHub {
            owner = "redox-os";
            repo = "gcc";
