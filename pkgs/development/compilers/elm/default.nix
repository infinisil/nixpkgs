{ pkgs, lib, makeWrapper, nodejs ? pkgs.nodejs_18 }:
    ...
    pkgs.haskell.packages.ghc92.override {
      overrides = self: super:
        ...
        in elmPkgs // {
          ...
          unordered-containers = overrideCabal (drv: { doCheck = false; })
...
in lib.makeScope pkgs.newScope (self:
  with self;
  {
    ...
    */
    elmLib = let hsElmPkgs = hs810Pkgs self;
    ...
    with (hs810Pkgs self).elmPkgs; {
      ...
      elm-coverage = let
        patched =
          patchNpmElm (patchBinwrap [ elmi-to-json ] nodePkgs.elm-coverage);
      in patched.override (old: {
      ...
      elm-review = nodePkgs.elm-review // {
        meta = with lib;
          nodePkgs.elm-review.meta // {
            ...
            homepage =
              "https://package.elm-lang.org/packages/jfmengels/elm-review/${nodePkgs.elm-review.version}";
            license = licenses.bsd3;
            maintainers = [ maintainers.turbomack ];
          };
      };
