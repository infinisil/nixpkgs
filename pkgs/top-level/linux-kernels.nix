...
in {
  ...
  kernels = recurseIntoAttrs (lib.makeExtensible (self:
    ...
    in {
      ...
      linux_6_2 = throw
        "linux 6.2 was removed because it has reached its end of life upstream";
  ...
  */
    ...
    lib.makeExtensible (self:
      ...
      in {
        ...
        lenovo-legion-module =
          callPackage ../os-specific/linux/lenovo-legion { };
  ...
  vanillaPackages = {
    ...
    linux_6_2 = throw
      "linux 6.2 was removed because it reached its end of life upstream"; # Added 2023-05-26
  };
  ...
  packages = recurseIntoAttrs (vanillaPackages // rtPackages // rpiPackages // {
    ...
    linux_4_14_hardened =
      recurseIntoAttrs (packagesFor kernels.linux_4_14_hardened);
    linux_4_19_hardened =
      recurseIntoAttrs (packagesFor kernels.linux_4_19_hardened);
    linux_5_4_hardened =
      recurseIntoAttrs (packagesFor kernels.linux_5_4_hardened);
    linux_5_10_hardened =
      recurseIntoAttrs (packagesFor kernels.linux_5_10_hardened);
    linux_5_15_hardened =
      recurseIntoAttrs (packagesFor kernels.linux_5_15_hardened);
    linux_6_1_hardened =
