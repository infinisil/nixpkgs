  ...
  packageOverrides = super:
    ...
    lib.mapAttrs (_: set: recurseIntoAttrs set) {
      inherit (super)
          ...
          quicklispPackagesClisp quicklispPackagesSBCL rPackages
          roundcubePlugins sconsPackages sourceHanPackages steamPackages
          ut2004Packages zabbix40 zabbix50 zabbix60 zeroadPackages;
