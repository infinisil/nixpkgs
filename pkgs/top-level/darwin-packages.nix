...
in makeScopeWithSplicing (generateSplicesForMkScope "darwin") (_: { })
(spliced: spliced.apple_sdk.frameworks) (self:
  ...
  in impure-cmds // appleSourcePackages // chooseLibs // {
    ...
    in nixos.config.system.build.macos-builder-installer;
  })
